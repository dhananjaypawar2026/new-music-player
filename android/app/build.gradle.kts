...
android {
    namespace = "com.dhananjaypawar.playmusic"
    ...
    defaultConfig {
        applicationId = "com.dhananjaypawar.playmusic"
    ...
    productFlavors {
        create("production") {
            dimension = "default"
            resValue("string", "app_name", "Play Music")
            applicationIdSuffix = ""
        }
        create("dev") {
            dimension = "default"
            resValue("string", "app_name", "Play Music Dev")
