...
![Play Music App Screenshots](screenshots/combined.jpg)

Introducing "Play Music" – Your Timeless Audio Experience

Step back in time with Play Music, a local music player app designed to capture the nostalgic essence
...
🗃️ Local Music Library: Play Music is focused on your locally stored music files, ensuring that your
...
🖌️ Customizable Themes: Personalize your Play Music experience with the option of silver or grey
...
display. Play Music pays homage to the visual appeal of classic iPods by showcasing your favorite
album covers in a retro-inspired format.

🎼 No Frills, Just Music: Play Music stays true to the essence of a music player – no distractions, no
...
🎧 Offline Listening: Enjoy your music without relying on an internet connection. Play Music is
perfect for those moments when you want to disconnect and savor the tunes stored locally on your
device.

Relive the magic of the iPod Classic with Play Music – where timeless design meets the convenience of
...
Download ready-to-install files from:
https://github.com/dhananjaypawar2026/new-music-player/releases/latest
...
You can also build install files directly from GitHub Actions:

1. Open the `Actions` tab.
2. Select `Build Install Files`.
3. Click `Run workflow`.
4. Download the generated APK, web build, or Windows ZIP from the workflow artifacts.

See [INSTALL.md](INSTALL.md) for the full install and build steps.
...
<table>
  ...
  <tr>
    <td>Android</td>
    <td>
      <a href="https://play.google.com/store/apps/details?id=com.dhananjaypawar.playmusic">
      ...
      <br>
      <a href="https://f-droid.org/packages/com.dhananjaypawar.playmusic">
        <img height="80" alt="Get it on F-Droid" src="https://f-droid.org/badge/get-it-on.png">
      </a>
      <br>
      <a href="https://github.com/DhananjayPawar2023/play-music-/releases/latest/download/Play Music-Android.apk">
  ...
  <tr>
      <td>Linux</td>
      <td>
        <a href="https://github.com/DhananjayPawar2023/play-music-/releases/latest/download/Play Music-Linux-AppImage.AppImage">
        ...
        <br>
        <br>
        <a href="https://github.com/DhananjayPawar2023/play-music-/releases/latest/download/Play Music-Linux-deb.deb">
        ...
        <br>
        <br>
        <a href="https://github.com/DhananjayPawar2023/play-music-/releases/latest/download/Play Music-Linux-rpm.rpm">
  ...
  <tr>
      <td>Windows</td>
      <td>
        <a href="https://github.com/DhananjayPawar2023/play-music-/releases/latest/download/Play Music-Windows.exe">
  ...
  <tr>
      <td>Web App</td>
      <td>
        <a href="https://DhananjayPawar2023.github.io/play-music-/#/">
...
**[Dhananjay Pawar](https://github.com/DhananjayPawar2023)**

## 🔖 LICENCE

Copyright (c) 2026 Dhananjay Pawar

This project is based on BSD-4-Clause licensed software. The original
copyright notice remains in the repository license file as required.

[BSD-4-Clause LICENCE](https://github.com/DhananjayPawar2023/play-music-/blob/master/LICENSE)
