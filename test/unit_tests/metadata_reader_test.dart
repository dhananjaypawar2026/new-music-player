  ...
  test('Reading the mp3 Metadata correctly', () {
    ...
    expect(
      ...
      MusicMetadata(
        ...
        thumbnailPath:
            "${Directory.current.path}/test/test_files/play_music/thumbnails/FadedbyAlanWalker.jpg",
        lyrics:
  ...
  test('Reading the ogg Metadata correctly', () {
    ...
    expect(
      ...
      MusicMetadata(
        ...
        thumbnailPath:
            "${Directory.current.path}/test/test_files/play_music/thumbnails/FireflybyJimYosef.jpg",
      ),
    );
  });
  ...
  test('Reading the opus Metadata correctly', () {
    ...
    expect(
      ...
      MusicMetadata(
        ...
        thumbnailPath:
            "${Directory.current.path}/test/test_files/play_music/thumbnails/SpectrebyAlanWalker.jpg",
      ),
    );
  });
  ...
  test('Reading the m4a Metadata correctly', () {
    ...
    expect(
      ...
      MusicMetadata(
        ...
        thumbnailPath:
            "${Directory.current.path}/test/test_files/play_music/thumbnails/On&OnbyCartoon&DanielLevi.jpg",
      ),
    );
  });
    ...
    expect(
      ...
      MusicMetadata(
        ...
        filePath:
            "${Directory.current.path}/test/test_files/wav/Invincible.wav",
        thumbnailPath:
            "${Directory.current.path}/test/test_files/play_music/thumbnails/InvinciblebyDeafKev.jpg",
      ),
    );
  });
}
